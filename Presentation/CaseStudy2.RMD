...
# Abstract
---
The study described in this proposal seeks to analyze procrastination and developmentnal data by country in order to better understand the statistical ties between the two and the spatial distribution across the globe.  The goal of this study is to provide clients useful information to avoid large overhead costs due to procrastination costs.
